	...
	return (
		<div id="hero" className='w-[70%] flex justify-center items-center flex-col pt-22'>
			...
			<div className="hero-btns">
				<a href='https://api.whatsapp.com/send/?phone=%2B919574683264&text&type=phone_number&app_absent=0' target='_blank' className="wabtn relative overflow-hidden group">
					<span className="flex items-center gap-2 relative z-10">
						<svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 448 512" className="text-xl" height="1.2em" width="1.2em" xmlns="http://www.w3.org/2000/svg">
			...
			<div className="hero-services">
				...
				<div className='hservice'><Check color="#ec4899" /> AI/ML</div>
				<div className='hservice'><Check color="#ec4899" /> MERN</div>
				<div className='hservice'><Check color="#ec4899" /> Strategy</div>
			</div>
		</div>
	)
}
